...
class Cart
{
     ...
     */
    public function add($id, $name = null, $qty = null, $price = null, $weight = 0, array $options = [],$slug =null)
    {
        if ($this->isMulti($id)) {
        ...
        $cartItem = $this->createCartItem($id, $name, $qty, $price, $weight, $options, $slug);
