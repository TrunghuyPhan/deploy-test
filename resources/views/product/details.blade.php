				...
				<div class="product-count">
					...
					<form action="{{URL::to('/save-cart')}}" method="POST">
						...
						<div class="display-flex">
							<div onclick="tru()" class="qtyminus ">-</div>
							<input type="text" name="qty" min="1" id="qty" value="1" class="qty">
							<input name="productid_hidden" type="hidden" value="{{$value->product_id}}" />
							<div onclick="cong()" class="qtyplus">+</div>

						</div>


						<button type="submit" style="display:block" class="btn round-black-btn">
...
<!--/recommended_items-->
<h2 style="text-align: center;border-bottom: 2px solid #d8d8d8;">Sản phẩm liên quan</h2>
...
<script>
	function cong() {
		var now = parseInt(document.getElementById("qty").value);
		var tong = now + 1;
		document.getElementById("qty").value = tong;
	}
	...
	function tru() {
		...
		if (now - 1 > 0) {
			hieu = now - 1;
			document.getElementById("qty").value = hieu;
		} else {
			document.getElementById("qty").value = now;
		}
	}
</script>